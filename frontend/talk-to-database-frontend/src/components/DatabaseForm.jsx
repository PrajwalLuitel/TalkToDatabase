...
const DatabaseForm = () => {
  ...
  const handleChange = (e) => {
    ...
    return (
      <div className="max-w-[90%] mt-10 mx-auto rounded-xl p-4 bg-fixed bg-gradient-to-t from-emerald-100 to-emerald-500 shadow-lg shadow-emerald-800 mb-14 pb-14 ">
      <h1 className={`mx-auto w-fit text-center text-emerald-100 text-[1.5rem] ${montserrat.className}`}>Please Enter the Details to Connect to Your Database:</h1>
      <form
      className="flex flex-col gap-4 max-w-[75%] max-md:max-w-[90%] mt-14 max-md:mt-0 mx-auto p-8 bg-emerald-50 shadow-xl shadow-emerald-900 rounded-xl text-black"
